...
#    OJO: evitamos "reemplazos fantasma" cuando ya está la versión nueva
pattern_standalone = re.compile(
    rf"(?<![_0-9A-Za-z])(?!{re.escape(tool_version)})(?:{VERSION_RE})(?![_0-9A-Za-z])"
)
updated, n3 = pattern_standalone.subn(tool_version, updated)
