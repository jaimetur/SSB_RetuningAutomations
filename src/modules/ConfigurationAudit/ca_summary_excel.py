...
def build_summary_audit(
    ...
    tips_by_metric: Dict[tuple[str, str], str] = {
        ...
        ("NRFreqRelation", f"NR nodes with with some cells missing relations to new SSB ({n77_ssb_post})"): "Nodes with any relations Step1 pending",
        ...
        ("GUtranFreqRelation", f"LTE nodes with with some cells missing relations to new SSB  {expected_new_rel_id}"): " ",
