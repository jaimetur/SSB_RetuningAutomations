...
def build_summary_audit(
    ...
    tips_by_metric: Dict[tuple[str, str], str] = {
        ...
        ("NRCellDU", f"NR Nodes with ssbFrequency"): "Tip to be defined",
        ("NRCellDU", f"NR LowMidBand Nodes"): "Tip to be defined",
        ("NRCellDU", f"NR mmWave Nodes"): "Tip to be defined",
        ("NRCellDU", f"NR nodes with N77 SSB in band (646600-660000)"): "Tip to be defined",
        ...
        ("NRSectorCarrier", f"NR nodes with N77 ARCFN in band (646600-660000)"): "Tip to be defined",
        ...
        ("NRFreqRelation", f"NR nodes with the old N77 SSB ({n77_ssb_pre})"): "Tip to be defined",
        ("NRFreqRelation", f"NR nodes with the new N77 SSB ({n77_ssb_post})"): "Tip to be defined",
        ("NRFreqRelation", f"NR nodes with both, the old N77 SSB ({n77_ssb_pre}) and the new N77 SSB ({n77_ssb_post})"): "Tip to be defined",
        ("NRFreqRelation", f"NR nodes with the old N77 SSB ({n77_ssb_pre}) but without the new N77 SSB ({n77_ssb_post})"): "Tip to be defined",
        ("NRFreqRelation", f"NR nodes with the old N77 SSB ({n77_ssb_pre}) and the new SSB ({n77_ssb_post})"): "Need to run Step1 on these nodes",
        ("NRFreqRelation", f"NR nodes with the old N77 SSB ({n77_ssb_pre}) but without new N77 SSB ({n77_ssb_post})"): "Nodes with any relations Step1 pending",
        ...
        ("NRFreqRelation", f"NR nodes with the N77 SSB not in ({n77_ssb_pre}, {n77_ssb_post})"): "Tip to be defined",
        ...
        ("NRCellRelation", f"NR cellRelations to new N77 SSB ({new_ssb})"): "Tip to be defined",
        ...
        ("GUtranFreqRelation", f"LTE nodes with GUtranFreqRelationId {expected_old_rel_id} and {expected_new_rel_id}"): "Tip to be defined",
        ("GUtranFreqRelation", f"LTE nodes with GUtranFreqRelationId {expected_old_rel_id} but without {expected_new_rel_id}"): "Tip to be defined",
        ("GUtranFreqRelation", f"LTE nodes with the N77 SSB not in ({n77_ssb_pre}, {n77_ssb_post})"): "Tip to be defined",
        ("GUtranFreqRelation", f"LTE nodes with Auto-created GUtranFreqRelationId to new N77 SSB ({n77_ssb_post}) but not following VZ naming convention ({n77_ssb_post}-30-20-0-1)"): "Tip to be defined",
        ...
        ("ExternalGUtranCell", f"External cells to old N77 SSB ({old_ssb})"): "Tip to be defined",
        ("ExternalGUtranCell", f"External cells to new N77 SSB ({new_ssb})"): "Tip to be defined",
        ...
        ("ExternalGUtranCell", f"External cells to new N77 SSB ({new_ssb}) with serviceStatus=OUT_OF_SERVICE"): "Tip to be defined",
        ...
        ("FreqPrioNR", f"NR nodes with RATFreqPrioId = 'fwa' in N77 band"): "Tip to be defined",
        ("FreqPrioNR", "NR nodes with RATFreqPrioId = 'publicsafety' in N77 band"): "Tip to be defined",
